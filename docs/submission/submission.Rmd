...
\noindent The preregistration, data, and scripts can be accessed using either of the following links: https://osf.io/wsdpv/ or https://github.com/cartermaclab/proj_power-motor-behavior.
