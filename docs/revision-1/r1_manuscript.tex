...
\textcolor{blue}{Studies published in Human Movement Science included a power analysis (59/271) 18\% of the time, the Journal of Motor Learning and Development (9/128) 10\% of the time, and the Journal of Motor Behavior (16/152) 7\% of the time. The 3-samples proportions test was significant, $\chi^2$ = 13.52, \emph{df} = 2, \emph{p} = .001.}
